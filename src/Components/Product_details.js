                                ...
                                <div id="myCarousel" class="carousel slide cntr">
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <a href="#"> <img src="assets/img/a.jpg" alt="" style="width:100%"></img></a>
                                        </div>
                                        <div class="item">
                                            <a href="#"> <img src="assets/img/b.jpg" alt="" style="width:100%"></img></a>
                                        </div>
                                        <div class="item">
                                            <a href="#"> <img src="assets/img/e.jpg" alt="" style="width:100%"></img></a>
                                        </div>
                                    </div>
                            ...
                            <div class="span7">
                                ...
                                <form class="form-horizontal qtyFrm">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="number" class="span6" placeholder="Qty."></input>
                                        </div>
                                    </div>
